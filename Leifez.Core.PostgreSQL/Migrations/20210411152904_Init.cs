    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => x.HashId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CollectionsId = table.Column<string>(type: "character varying(36)", nullable: false),
                    ImagesGuid = table.Column<string>(type: "character varying(36)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DbCollectionDbUser", x => new { x.CollectionsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_DbCollectionDbUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DbCollectionDbUser_Collections_CollectionsId",
                        column: x => x.CollectionsId,
                        principalTable: "Collections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DbCollectionDbUser_UsersId",
                table: "DbCollectionDbUser",
                column: "UsersId");
